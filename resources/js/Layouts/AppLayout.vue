            ...
            <header class="bg-white border-b border-slate-200 sticky top-0 z-10">
                <div class="flex h-16 items-center justify-between px-6">
                    ...
                    <div class="flex items-center gap-x-4">
                        ...
                        <span class="badge bg-slate-100 text-slate-700 ring-slate-200">{{ primaryRole }}</span>
...
import { HomeIcon, BuildingOffice2Icon, UsersIcon, DocumentTextIcon,
    BanknotesIcon, ArrowsRightLeftIcon, BellAlertIcon, ChartBarIcon, Cog6ToothIcon } from '@heroicons/vue/24/outline';
...
const nav = computed(() => {
    ...
    return [
        ...
        { name: 'Reports',     href: '/reports',                   icon: ChartBarIcon,         current: current.startsWith('/reports') },
